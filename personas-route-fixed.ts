...
export async function GET(request: Request) {
  ...
  try {
    ...
    return safeHandleApiError(error, "/api/personas", userId);
  }
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    try {
      ...
      return safeHandleApiError(validationError, "/api/personas", userId);
    }
  } catch (error) {
    return safeHandleApiError(error, "/api/personas", userId);
  }
  ...
  try {
    ...
    try {
      ...
      const updatedPersona = await prisma.persona.update({
        where: {
          id,
          userId, // Ensure user can only update their own personas
        },
        data: {
          title,
          description: description || null,
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    await prisma.persona.delete({
      where: {
        id,
        userId, // Ensure user can only delete their own personas
      },
    });
