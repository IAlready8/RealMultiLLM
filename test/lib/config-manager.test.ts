...
describe('ConfigurationManager', () => {
  ...
  describe('getSystemConfig', () => {
    ...
    it('should force refresh when requested', async () => {
      ...
      expect(config1).not.toBe(config2) // Different object reference (refreshed)
    })
  })
  ...
  describe('getProviderConfig', () => {
    ...
    it('should handle missing settings gracefully', async () => {
      ...
      expect(config?.models).toEqual(['gpt-4', 'gpt-4-turbo', 'gpt-3.5-turbo']) // Default models
      expect(config?.rateLimits).toEqual({ requests: 60, window: 60000 }) // Default rate limits
    })
  })
  ...
  describe('updateProviderConfig', () => {
    it('should validate configuration before saving', async () => {
      const invalidConfig = {
        ...
        models: [],
        rateLimits: { requests: 0, window: 500 }, // Invalid values
      }
      
      const result = await configManager.updateProviderConfig('user-1', 'openai', invalidConfig)
  ...
  describe('validateSystemConfig', () => {
    ...
    it('should reject invalid system configuration', () => {
      const invalidConfig = {
        ...
        security: {
          sessionTimeout: 100, // Too low
        },
      }
      
      const result = configManager.validateSystemConfig(invalidConfig)
  ...
  describe('validateProviderConfig', () => {
    ...
    it('should reject invalid provider configuration', () => {
      const invalidConfig = {
        ...
        rateLimits: {
          requests: -1, // Should be positive
          window: 100, // Too low
        },
      }
      
      const result = configManager.validateProviderConfig(invalidConfig)
      expect(result.ok).toBe(false)
      expect(result.errors).toBeDefined()
    })
  })
  ...
  describe('cache management', () => {
    it('should invalidate cache', async () => {
      ...
      expect(config1).not.toBe(config2) // Different instances after cache invalidation
    })
    ...
    it('should refresh cache', async () => {
      ...
      expect(config1).not.toBe(config2) // Different instances after refresh
    })
  })
